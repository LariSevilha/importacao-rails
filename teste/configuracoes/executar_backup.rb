...
seed_file = File.new("backup_execution_seed.rb", "w")

begin
  doc = Nokogiri::HTML(URI.open('https://agenciaw3.digital/ajuda/backup/tutoriais-para-backup/tutorial/como-executar-um-conjunto-de-backup'))
