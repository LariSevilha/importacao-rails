...
seed_file = File.new("conjunto_seed.rb", "w")

begin
  doc = Nokogiri::HTML(URI.open('https://agenciaw3.digital/ajuda/backup/tutoriais-para-backup/tutorial/criando-conjunto-de-backup'))
