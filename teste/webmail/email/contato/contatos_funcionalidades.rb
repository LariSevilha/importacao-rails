...
seed_file = File.new("contatos_funcionalidades_seed.rb", "w") # Append to existing seed file

begin
  doc = Nokogiri::HTML(URI.open('https://www.agenciaw3.digital/ajuda/email-corporativo/email/tutorial/contatos-funcionalidades'))
