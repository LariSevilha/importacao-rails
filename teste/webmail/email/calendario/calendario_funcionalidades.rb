...
seed_file = File.new("calendario_funcionalidades_seed.rb", "w") # Append to existing seed file

begin
  doc = Nokogiri::HTML(URI.open('https://www.agenciaw3.digital/ajuda/email-corporativo/email/tutorial/calendario-funcionalidades'))
